...
- ai-for-manufacturing.html (28 links) ✅ — 2026-05-06 depth pass commit d38cf3a: 5 contextual link strips + Idaho manufacturing service-area fit section + FAQPage schema synced to visible FAQs; sitemap lastmod updated; QA passed (1 H1, JSON-LD valid, CSS balanced, phone bytes real, sitemap count 1, no overflow at 375/768/1440 via Playwright probe).
- ai-implementation-plan.html (23 links) ✅ — 2026-05-06 depth pass commit 74ed574: 4 contextual link strips + Idaho implementation service-area fit section; sitemap lastmod updated; QA passed (1 H1, JSON-LD valid, CSS balanced, phone bytes real, sitemap count 1, no overflow at 375/768/1440 via Playwright probe).
...
10. ai-for-manufacturing.html (28 links) ✅
...
17. Regional pages: ai-services-boise through ai-services-wood-river-valley (all 9 links)
    ...
    - ai-services-twin-falls.html (21 body links) ✅ — 2026-05-07 depth pass commit aa0df0c: 4 contextual link strips after Magic Valley growth, process, request, and FAQ sections; FAQPage JSON-LD synced to all 7 visible FAQs; sitemap lastmod updated; QA passed (1 H1, JSON-LD valid, CSS balanced, phone bytes real, sitemap count 1, no overflow at 375/768/1440 via same-origin iframe probe).
    - ai-services-pocatello.html ← NEXT
